#begin vertex
// shader to create cel shading outlines
// meant to be used as the final pass of the pipeline
#version 330 core
...
void main() {
    Col = texture(screenTex, TexCoords);
    Col = Col * vec4(vec3(1.0 - sobel_kernel()), 1.0);
}
#end fragment
